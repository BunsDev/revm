...
## [7.0.6](https://github.com/BunsDev/revm/compare/revm-state-v7.0.5...revm-state-v7.0.6) - 2025-10-03

### Fixed

- Apply spelling corrections from PRs #2926, #2915, #2908 ([#2978](https://github.com/BunsDev/revm/pull/2978))
- skip cold load on oog ([#2903](https://github.com/BunsDev/revm/pull/2903))

### Other

- helper caller_initial_modification added ([#3032](https://github.com/BunsDev/revm/pull/3032))
- *(state)* remove unnecessary core::hash::Hash import from lib.rs ([#2959](https://github.com/BunsDev/revm/pull/2959))
- add SECURITY.md ([#2956](https://github.com/BunsDev/revm/pull/2956))
- use primitives::HashMap default ([#2916](https://github.com/BunsDev/revm/pull/2916))
