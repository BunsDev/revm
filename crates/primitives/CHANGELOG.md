...
## [21.0.0](https://github.com/BunsDev/revm/compare/revm-primitives-v20.2.1...revm-primitives-v21.0.0) - 2025-10-03

### Added

- *(revme)* ef blockchain tests cli ([#2935](https://github.com/BunsDev/revm/pull/2935))

### Fixed

- Align no_std OnceLock semantics with std ([#3026](https://github.com/BunsDev/revm/pull/3026))
...
- *(cleanup)* Remove EIP-7918 related functions and EIP file  ([#2925](https://github.com/BunsDev/revm/pull/2925))
